    ...
    <section className={`py-32 px-6 md:px-12 lg:px-24 ${styles.draftPaperPattern}`}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          <h2
            className="text-4xl sm:text-5xl font-black uppercase text-[var(--psg-maroon)] tracking-tight leading-none mb-4"
            style={{ fontFamily: 'var(--font-display)' }}
          >
            Partnerships That Built Things.
          </h2>
          <p className={`${styles.fontSans} text-[var(--psg-steel)] text-base max-w-xl mx-auto leading-relaxed mt-4`}>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-[var(--psg-maroon)] group-hover:bg-[var(--psg-gold)] transition-all duration-300" />

        {/* Year Label */}
        <div
          className="text-[var(--psg-gold)] font-black text-3xl tracking-tight leading-none mb-3"
          style={{ fontFamily: 'var(--font-display)' }}
        >
          {item.year}
        </div>
        ...
        <p className={`${styles.fontSans} text-[var(--psg-steel)] text-sm mt-2 font-medium leading-relaxed`}>
          {item.details}
        </p>
